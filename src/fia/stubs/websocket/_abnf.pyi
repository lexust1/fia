...
class ABNF:
    ...
    def validate(self, skip_utf8_validation: Any=...) -> None: ...
    @staticmethod
    def create_frame(data: Any, opcode: Any, fin: int = ...): ...
    def format(self) -> bytes: ...
    @staticmethod
    def mask(mask_key: Any, data: Any): ...
...
class frame_buffer:
    ...
    recv_buffer: Any = ...
    lock: Any = ...
    def __init__(self, recv_fn: Any, skip_utf8_validation: Any) -> None: ...
    header: Any = ...
    length: Any = ...
    mask: Any = ...
    def clear(self) -> None: ...
...
class continuous_frame:
    ...
    cont_data: Any = ...
    recving_frames: Any = ...
    def __init__(self, fire_cont_frame: Any, skip_utf8_validation: Any) -> None: ...
    def validate(self, frame: Any) -> None: ...
    def add(self, frame: Any) -> None: ...
    def is_fire(self, frame: Any): ...
